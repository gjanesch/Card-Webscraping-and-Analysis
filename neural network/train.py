...
VOCABULARY_SIZE = int(os.environ.get("VOCABULARY_SIZE", "900"))
EMBEDDING_DIM = int(os.environ.get("EMBEDDING_DIM", "50"))   # 48
HIDDEN_DIM = int(os.environ.get("HIDDEN_DIM", "160"))      # 128
NEPOCH = int(os.environ.get("NEPOCH", "2"))
MODEL_OUTPUT_FILE = os.environ.get("MODEL_OUTPUT_FILE")
INPUT_DATA_FILE = os.environ.get("INPUT_DATA_FILE", "card_texts.csv")
